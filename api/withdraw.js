  ...
  try {
    ...
    await db.runTransaction(async (tr) => {  
      try {
        ...
        throw new Error(innerErr.message || "خطأ داخلي أثناء تنفيذ المعاملة");
      }
    });  
    ...
    console.error("Withdrawal Handler Error:", err);
    const message = err.message || "حدث خطأ غير متوقع، يرجى المحاولة لاحقاً.";
